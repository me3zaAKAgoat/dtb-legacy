...
const AddTaskForm = ({ tasks, setTasks, user, setFormToOpen }) => {
	const initialRender = useRef(true);
	const [nameField, setUsernameField] = useState('');
	const [descriptionField, setDescriptionField] = useState('');
	const [priorityField, setPriorityField] = useState('');
	const [AddTaskFormSubmitted, setAddTaskFormSubmitted] = useState(false);
	...
	return (
		<form
			onSubmit={(event) => {
				...
				setAddTaskFormSubmitted(!AddTaskFormSubmitted);
			}}
		>
